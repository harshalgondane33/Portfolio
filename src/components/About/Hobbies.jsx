      ...
      <div className="grid grid-flow-row grid-cols-1 lg:grid-cols-2 gap-5 ">
        <div className="">
          <p className="text-xl lg:text-start ">
            ...
            day. Finally, I also enjoy Playing Cricket And Playing Chess. It’s a great way to stay active
        ...
        <ImageList>
          ...
          <HobbiyCard
            ...
            title="Cricket"
            description="I love playing Crcket"
            image="/images/playing-cricket.jpg"
          />
          <HobbiyCard
            title="Playing Chess"
            description="I love playing Chess"
