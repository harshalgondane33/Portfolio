  ...
  return (
    ...
    >
      ...
      <p className="text-center text-xl mt-4">
        Hi, {`I'm`} Harshal Gondane and I love making projects and solving real world
        ...
        GitHub page{' '}
        <Link className="font-bold" to={`https://www.linkedin.com/in/harshal-gondane-bb55bb130/`}>
          @harshalgondane33{' '}
        </Link>{' '}
