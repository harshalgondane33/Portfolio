...
export default function Resume() {
  ...
  const handleDownload = () => {
    if (selectedIndex === 0) {
      ...
      a.href = '/resume/Harshal-Resume.pdf'
      a.download = 'Harshal-Resume.pdf'
      document.body.appendChild(a)
      a.click()
      document.body.removeChild(a)
    } else {
      const a = document.createElement('a')
      a.href = '/resume/Harshal-resume.png'
      a.download = 'Harshal-Resume.png'
      document.body.appendChild(a)
      a.click()
      document.body.removeChild(a)
    }
  ...
  const handleView = () => {
    if (selectedIndex === 0) {
      window.open('/resume/Harshal-Resume.pdf', '_blank')
    } else {
      window.open('/resume/Harshal-resume.png', '_blank')
    }
  }
